...
?>
            <form action="" name="form" onsubmit="return validateForm();" method="post">
                ...
                <div class="mb-3"><label class="form-label">County</label><input class="form-control" value="<?php echo $data['country'] ?>" type="text" name="country" id="country" placeholder="Country"><span id="keencountry"></span></div>
