...
$command="UPDATE  docket
 SET 
 crime_type='$crimetype', year='$year'
 WHERE docket_id='$id'";
...
echo '<script>alert(" Information Updated.");window.location = "criminal.php";</script>';
    ...
    <section class="register-photo" style="background: rgb(255,255,255);">
        <div class="form-container">
            <form name="form" onsubmit="return validateForm();"  method="post" >
                ...
                <div class="mb-3"><label class="form-label">Crime type</label><input class="form-control" type="text" name="crimetype" value="<?php echo $data['crime_type']?>" placeholder="Crimetype"><span id="crimeerror"></span></div>
                <div class="mb-3"><label class="form-label">Year</label><input class="form-control" type="text" name="year" value="<?php echo $data['year']?>" placeholder="year"><span id="yerror"></span></div>
