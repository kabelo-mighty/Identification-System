...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['name'])) {
  app_require_csrf_token('view.php?value=' . $personId);
  ...
  if (!$updated) {
    app_redirect('view.php?value=' . $personId, 'Information could not be updated.');
  }
...
<head>
    ...
    <title>Identification System | Citizen Profile</title>
        ...
        <aside class="glass-panel app-card w-full rounded-[2rem] p-5 lg:sticky lg:top-4 lg:h-[calc(100vh-2rem)] lg:w-80 lg:self-start">
            <div class="flex items-center gap-4 border-b border-white/10 pb-5">
                ...
                <div>
                    ...
                    <h1 class="mt-1 text-xl font-bold text-white">Citizen profile</h1>
                </div>
            </div>
        ...
        <main class="flex-1 space-y-6">
            <section class="glass-panel-strong app-card rounded-[2rem] p-6 md:p-8">
                <div class="flex flex-col gap-5 xl:flex-row xl:items-end xl:justify-between">
                    <div>
                        ...
                        <p class="mt-4 max-w-3xl text-base leading-7 text-slate-300">Update the citizen record, including contact details, address information, and next-of-kin data, from the same modern admin workspace.</p>
                    </div>
                    <div class="flex flex-col gap-3 sm:flex-row">
                        <a class="app-button app-button-secondary" href="people.php"><i class="fa fa-arrow-left"></i>Back to Citizens</a>
            ...
            <form method="post" action="" class="space-y-6">
                ...
                <div class="flex flex-col gap-3 sm:flex-row sm:justify-end">
                    <a class="app-button app-button-secondary" href="people.php"><i class="fa fa-times"></i>Cancel</a>
