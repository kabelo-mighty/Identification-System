...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['name'])) {
  app_require_csrf_token('viewpolice.php?value=' . $id);
  ...
  if (!$updated) {
    app_redirect('viewpolice.php?value=' . $id, 'Information could not be updated.');
  }
  ...
  <?php echo app_render_alert($flashMessage); ?>
    <section class="register-photo" style="background: rgb(255,255,255);">
        ...
        <?php echo app_csrf_input(); ?>
                ...
                <h1 class="text-center" style="font-family: ABeeZee, sans-serif;font-size: 21px;">Police information<a class="float-end" href="police.php"><i class="fas fa-window-close" style="color: rgb(44,32,252);"></i></a></h1>
                <hr>
                <p style="color: rgb(44,32,252);">Personal information</p>
                <div class="mb-3"><label class="form-label">Firs tname</label><input readonly="" class="form-control" type="text" id="name" value="<?php echo $data['firstname']?>" name="name" placeholder="Firstname"><span id="nerror"></span></div>
                <div class="mb-3"><label class="form-label">Last name</label><input readonly="" class="form-control" type="text" value="<?php echo $data['lastname']?>" name="surname" id="surname" placeholder="Lastname"><span id="serror"></span></div>
                <div class="mb-3"><label class="form-label">Id number</label><input readonly="" class="form-control" type="text" value="<?php echo $data['id_number']?>" readonly="" name="idno" id="idno" placeholder="Id number"><span id="iderror"></span></div>
                <div class="mb-3"><label class="form-label">Phone number</label><input readonly="" class="form-control" type="text" name="cellno" id="cellno"  value="<?php echo $data['phone']?>" placeholder="Phone"><span id="cerror"></span></div>
                <div class="mb-3"><label class="form-label">Email</label><input readonly="" class="form-control" type="text" id="email"  value="<?php echo $data['email']?>" name="email" readonly="" placeholder="Email"><span id="error"></span></div>
                <div class="mb-3"><label class="form-label">Gender</label><input readonly="" class="form-control" type="text" value="<?php echo $data['gender']?>" id="gender" name="gender" readonly="" placeholder="Gender"><span id="gerror"></span></div>
           
                <p style="color: rgb(44,32,252);">Address information</p>
                <hr>
               
                <div class="mb-3"><label class="form-label">House No.</label><input readonly="" class="form-control"  value="<?php echo $data['house_no'] ?>" type="text" name="houseno" id="houseno" placeholder="House no"><span id="keenhouse"></span></div>
                <div class="mb-3"><label class="form-label">Street name</label><input readonly="" class="form-control" value="<?php echo $data['street_name'] ?>" type="text" name="streetname" id="streetname" placeholder="Street name"><span id="keenstreet"></span></div>
                <div class="mb-3"><label class="form-label">Suburb</label><input readonly="" class="form-control" value="<?php echo $data['suburb'] ?>" type="text" name="suburb" id="suburb" placeholder="Suburb"><span id="keensuburb"></span></div>
                ...
                <div class="mb-3"><label class="form-label">Province</label><input readonly="" class="form-control" value="<?php echo $data['province'] ?>" type="text" name="province" id="province" placeholder="Province"><span id="keenprovince"></span></div>
                <div class="mb-3"><label class="form-label">Zip Code</label><input readonly="" class="form-control" value="<?php echo $data['zip_code'] ?>" type="text" name="zipcode" id="zipcode" placeholder="Zip code"><span id="keenzipcode"></span></div>
                <div class="mb-3"><label class="form-label">County</label><input readonly="" class="form-control" value="<?php echo $data['country'] ?>" type="text" name="country" id="country" placeholder="Country"><span id="keencountry"></span></div>
          
                <p style="color: rgb(44,32,252);">Next of keen information</p>
                <hr>
              
                <div class="mb-3"><label class="form-label">Firs tname</label><input readonly="" class="form-control" value="<?php echo $data['keen_firstname'] ?>" type="text" name="keenfirstname" id="keenfirstname" placeholder=""><span id="keenfname"></span></div>
                <div class="mb-3"><label class="form-label">Last name</label><input readonly="" class="form-control" value="<?php echo $data['keen_lastname'] ?>" type="text" name="keenlastname" id="keenlastname" placeholder=""><span id="keenlname"></span></div>
                <div class="mb-3"><label class="form-label">Phone number</label><input readonly="" class="form-control"  value="<?php echo $data['keen_phone'] ?>" type="text" name="kphone" id="kphone" placeholder=""><span id="keenphone"></span></div>
                <div class="mb-3"><label class="form-label">Email</label><input readonly="" class="form-control"  value="<?php echo $data['keen_email'] ?>" type="text" name="kemail" id="kemail" placeholder=""><span id="keenemail"></span></div>
