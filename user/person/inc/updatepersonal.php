...
$command="UPDATE  person
 SET 
 firstname='$name', lastname='$surname', gender='$gender',id_number='$idno',phone='$cellno',email='$email',employee_type='$emptype'
 WHERE person_id='$id'";
...
echo '<script>alert("Personal information Updated.");window.location = "profile.php";</script>';
