...
<head>
    ...
    <title> Identification System | Dashboard</title><link rel="icon" href="../../assets/img/logo.jpg">
      ...
      <!--end-->
        <div class="shadow" style="padding-top: 9px;border-radius: 10px;">
            <ul class="nav nav-tabs" role="tablist">
                <li class="nav-item" role="presentation"><a class="nav-link active" role="tab" data-bs-toggle="tab" href="#tab-1" style="font-size: 16px;color: rgb(44,32,252);font-weight: bold;"><i class="fa fa-home"></i>&nbsp;Home</a></li>
            ...
            <div class="tab-content">
                <div class="tab-pane fade show active" role="tabpanel" id="tab-1"><a class="btn" role="button"  style="border-style: none;color: rgb(132,132,132);font-size: 17px;" href="view.php">Dashboard<br></a></div>
